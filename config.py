...
SPEAKER_EMA_DECAY = 0.1
SPEAKER_HIGH_CONFIDENCE_THRESHOLD = 0.90
SPEAKER_MEDIUM_CONFIDENCE_THRESHOLD = 0.75
SPEAKER_BLACKLIST_THRESHOLD = 0.80
SPEAKER_STATS_FILE = os.path.join(MODELS_DIR, "speaker_stats.json")
